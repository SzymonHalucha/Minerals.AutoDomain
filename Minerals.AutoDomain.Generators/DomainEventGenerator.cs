namespace Minerals.AutoDomain.Generators
{
    ...
    public sealed class DomainEventGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            {
                ctx.AddSource($"{element.Name}.g.cs", GeneratePartialDomainEventObject(element));
            });
        }

        private static SourceText GeneratePartialDomainEventObject(DomainEventObject eventObj)
        {
        ...
        private static void AppendStructHeader(CodeBuilder builder, DomainEventObject eventObj)
        {
            ...
            builder.Write(eventObj.Keyword)
                .Write(" ")
                .Write(eventObj.Name)
