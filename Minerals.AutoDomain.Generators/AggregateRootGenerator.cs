    ...
    public sealed class AggregateRootGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(aggregates, static (ctx, element) =>
            {
                ...
                ctx.AddSource($"{element.Name}.g.cs", GeneratePartialAggregateRootObject(element));
            });
        }

        private static SourceText GeneratePartialAggregateRootObject(EntityObject entityObj)
        {
